...
class DatePickerAddQuizzesComponent extends GetView<TeacherAddExamController> {
  const DatePickerAddQuizzesComponent({Key? key}) : super(key: key);
  ...
  void showDate(
      ...
      required TeacherAddExamController controller}) {
